...
const SUCURSAL_ACTUAL = 'TOCUYITO';
...
async function asaltoBovedaFacturas() {
    ...
    while (!asaltoExitoso && intentosAsalto < 3) {
        ...
        try {
            ...
            await page.type('#id_sc_field_login', 'Agente 2 VIVIAN - Red Tocuyito', { delay: 50 });
            await page.type('#id_sc_field_pswd', '@VNtocuyito', { delay: 50 });
